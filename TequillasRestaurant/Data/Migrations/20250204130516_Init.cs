    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "A delicious taco filled with paneer and fresh vegetables", "Paneer Taco", 2.50m, 100 },
                    { 2, 2, "A flavorful burrito stuffed with mushrooms and beans", "Mushroom Burrito", 3.50m, 80 },
                    { 3, 2, "A tasty quesadilla with tofu and melted cheese", "Tofu Quesadilla", 3.99m, 90 }
                });
